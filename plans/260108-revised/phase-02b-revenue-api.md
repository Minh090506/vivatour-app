...
## Task 2B.1: Create Revenue History Utility (5 min)
...
## Task 2B.2: Update Lock Endpoint (8 min)
...
## Task 2B.3: Update Unlock Endpoint (8 min)
...
## Task 2B.4: Add Revenue History Endpoint (4 min)
...
## Task 2B.5: Add History Tracking to Revenue Create (Optional)

### File: `src/app/api/revenues/route.ts`

Add history entry on revenue creation:

```typescript
// Add import at top
import { createRevenueHistory } from '@/lib/revenue-history';

// After creating revenue, add history entry:
...
- [ ] RevenueHistory model created (Phase 1)
